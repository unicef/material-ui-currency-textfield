...
var InputAdornment = _react.default.forwardRef(function InputAdornment(props, ref) {
  ...
  if (variantProp && muiFormControl.variant) {
    process.env.NODE_ENV !== "production" ? (0, _warning.default)(variantProp !== muiFormControl.variant, 'Material-UI: The `InputAdornment` variant infers the variant prop ' + 'you do not have to provide one.') : void 0;
  }
