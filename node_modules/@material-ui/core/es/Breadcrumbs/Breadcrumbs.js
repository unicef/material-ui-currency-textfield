...
const Breadcrumbs = React.forwardRef(function Breadcrumbs(props, ref) {
  ...
  const renderItemsBeforeAndAfter = allItems => {
    ...
    if (itemsBeforeCollapse + itemsAfterCollapse >= allItems.length) {
      process.env.NODE_ENV !== "production" ? warning(false, ['Material-UI: you have provided an invalid combination of props to the Breadcrumbs.', `itemsAfterCollapse={${itemsAfterCollapse}} +itemsBeforeCollapse={${itemsBeforeCollapse}} >= maxItems={${maxItems}}`].join('\n')) : void 0;
      return allItems;
    }
