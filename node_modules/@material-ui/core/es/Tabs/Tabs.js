...
const Tabs = React.forwardRef(function Tabs(props, ref) {
  const {
    ...
    variant = 'standard'
        ...
        other = _objectWithoutPropertiesLoose(props, ["action", "centered", "children", "classes", "className", "component", "indicatorColor", "onChange", "orientation", "ScrollButtonComponent", "scrollButtons", "TabIndicatorProps", "textColor", "theme", "value", "variant"]);
